          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
                 ...
                 <Input
                   ...
                   className={errors.fname ? "border-red-500 focus:ring-red-500" : "focus:ring-orange-500 focus:border-orange-500"}
                 />
                 {errors.fname && (
               ...
               <div className="space-y-2">
                 ...
                 <Input
                   ...
                   className={errors.lname ? "border-red-500 focus:ring-red-500" : "focus:ring-orange-500 focus:border-orange-500"}
                 />
                 {errors.lname && (
             ...
             <div className="space-y-2">
               ...
               <Input
                 ...
                 className={errors.phone ? "border-red-500 focus:ring-red-500" : "focus:ring-orange-500 focus:border-orange-500"}
               />
               {errors.phone && (
             ...
             <div className="space-y-2">
               ...
               <Input
                 ...
                 className={errors.password ? "border-red-500 focus:ring-red-500" : "focus:ring-orange-500 focus:border-orange-500"}
               />
               {errors.password && (
               ...
               <div className="mt-3 p-3 bg-gray-50 rounded-lg">
                 ...
                 <div className="grid grid-cols-1 gap-1 text-xs">
                   <div className={`flex items-center space-x-2 ${passwordValidation.requirements.length ? "text-orange-600" : "text-red-500"}`}>
                     <span>{passwordValidation.requirements.length ? "✓" : "✗"}</span>
                     <span>At least 8 characters</span>
                   </div>
                   <div className={`flex items-center space-x-2 ${passwordValidation.requirements.uppercase ? "text-orange-600" : "text-red-500"}`}>
                     <span>{passwordValidation.requirements.uppercase ? "✓" : "✗"}</span>
                     <span>One uppercase letter</span>
                   </div>
                   <div className={`flex items-center space-x-2 ${passwordValidation.requirements.lowercase ? "text-orange-600" : "text-red-500"}`}>
                     <span>{passwordValidation.requirements.lowercase ? "✓" : "✗"}</span>
                     <span>One lowercase letter</span>
                   </div>
                   <div className={`flex items-center space-x-2 ${passwordValidation.requirements.number ? "text-orange-600" : "text-red-500"}`}>
                     <span>{passwordValidation.requirements.number ? "✓" : "✗"}</span>
                     <span>One number</span>
                   </div>
                   <div className={`flex items-center space-x-2 ${passwordValidation.requirements.special ? "text-orange-600" : "text-red-500"}`}>
                     <span>{passwordValidation.requirements.special ? "✓" : "✗"}</span>
                     <span>One special character (@#$%^&*)</span>
                   </div>
                   <div className={`flex items-center space-x-2 ${passwordValidation.requirements.strength ? "text-orange-600" : "text-red-500"}`}>
             ...
             <div className="space-y-2">
               ...
               <Input
                 ...
                 className={errors.confirmPassword ? "border-red-500 focus:ring-red-500" : "focus:ring-orange-500 focus:border-orange-500"}
               />

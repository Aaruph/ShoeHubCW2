            ...
            <div className="w-1/4">
              <div className="bg-white/80 backdrop-blur-sm rounded-lg shadow-lg p-6">
                ...
                <div className="space-y-3">
                  <button className="flex items-center gap-3 p-3 bg-orange-500 text-white rounded-lg w-full hover:bg-orange-600 transition-colors duration-300 font-medium">
                    <User size={20} /> My Profile
                  </button>
                  <Link to="/my-orders">
                    <button className="flex items-center gap-3 p-3 border border-gray-300 rounded-lg w-full bg-white text-gray-700 hover:bg-orange-50 hover:border-orange-300 transition-colors duration-300 font-medium">
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-lg shadow-lg p-8">
                ...
                <form onSubmit={handleProfileUpdate} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full p-3 border border-gray-300 rounded-lg text-gray-800 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-colors"
                  ...
                  <button
                    type="submit"
                    disabled={isLoading}
                    className={`w-full p-4 rounded-lg font-semibold text-white transition-colors duration-300 ${

...
const ItemCard = ({ item, customerId }) => {
    ...
    return (
        <div className="bg-green-50 p-4 rounded-lg shadow-md hover:bg-green-100 transition relative cursor-pointer group" onClick={() => navigate(`/item/details/${item._id}`)}>
            ...
            <div className="flex justify-between items-center mt-4">
                <h3 className="text-base font-semibold text-gray-800 cursor-pointer hover:text-[#00bf63] transition">
                    {item.name}
                </h3>
            </div>

    ...
    return (
        <>
            ...
            <div className="bg-gradient-to-br from-orange-50 via-white to-orange-100 min-h-screen">
                ...
                <section className="p-4 bg-white/80 backdrop-blur-sm shadow-md hover:bg-white/90 transition rounded-lg m-4">
                    <h2 className="text-2xl font-bold p-2 text-orange-600 mb-4">
                        Featured Collection
                    </h2>
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-6">
                        {featuredItems.length > 0 ? (
                            ...
                            <p className="text-gray-800 col-span-full text-center">No featured items available</p>
                        )}
                    </div>
                </section>
                <section className="p-4 bg-white/80 backdrop-blur-sm shadow-md hover:bg-white/90 transition rounded-lg m-4">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-6">
                        {trendingItems.length > 0 ? (
                            ...
                            <p className="text-gray-800 col-span-full text-center">No trending items available</p>
                        )}
                    </div>
                </section>
                <section className="p-4 bg-white/80 backdrop-blur-sm shadow-md hover:bg-white/90 transition rounded-lg m-4">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-6">
                        {bestSellerItems.length > 0 ? (
                            ...
                            <p className="text-gray-800 col-span-full text-center">No best seller items available</p>
                        )}
                    </div>
                </section>
                <section className="p-4 bg-white/80 backdrop-blur-sm shadow-md hover:bg-white/90 transition rounded-lg m-4">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-6">
                        {specialItems.length > 0 ? (
                            ...
                            <p className="text-gray-800 col-span-full text-center">No special items available</p>
                        )}
                    </div>
                </section>
            </div>

        ...
        {!otpVerified ? (
          <form onSubmit={handleVerifyOtp} className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full p-3 text-black border border-gray-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-orange-400"
            ...
            <button
              ...
              className={`w-full p-3 rounded-lg font-semibold text-white transition ${
                loading ? 'bg-orange-500 cursor-not-allowed' : 'bg-orange-500 hover:bg-orange-700'
              }`}
            >
              {loading ? (
          ...
          <form onSubmit={handleResetPassword} className="space-y-6">
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full p-3 text-black border border-gray-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-orange-500"
            ...
            <button
              ...
              disabled={loading}
              className={`w-full p-3 rounded-lg font-semibold text-white transition ${
                loading ? 'bg-orange-500 cursor-not-allowed' : 'bg-orange-500 hover:bg-orange-500'
              }`}
            >
              {loading ? (
                <div className="flex justify-center items-center space-x-2">

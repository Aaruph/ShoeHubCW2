            ...
            <div className="bg-gray-100 min-h-screen flex flex-col justify-center items-center py-20">
                <div className="bg-white p-12 rounded-xl shadow-xl text-center max-w-lg w-full border border-gray-200">
                    ...
                    <p className="text-lg text-gray-700 mb-8">
                        {sessionId 
                            ? "Your payment has been processed successfully and your order has been placed. Thank you for choosing Shoe Hub!"
                            : "Your order has been placed successfully. Thank you for choosing Shoe Hub!"
                        }
                    </p>
                    {/* <div className="bg-green-50 p-6 rounded-lg mb-8">
                        <h3 className="text-lg font-semibold text-orange-500 mb-2">Order Details</h3>
                    ...
                    <div className="space-x-4">
                        <button
                            ...
                            className="bg-orange-500 text-white px-8 py-4 rounded-lg text-lg shadow-md hover:bg-orange-600 transition ease-in-out duration-200 font-semibold"
                        >
                            Back to Home
                        </button>
                    </div>
